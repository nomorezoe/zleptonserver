...
function FluxPipeTextToImage(task, req, queue) {
    ...
    const promptFile = fs.readFileSync('./pipe/flux_text_2_image.json');//');
    ...
    const reqhttps = https.request(options, (reshttps) => {
        ...
        if (reshttps.statusCode == 200) {
            ...
            reshttps.on('end', (d) => {
                ...
                console.log("onend_flux_txt_to_img: " + task.key + " , time: ");
                for (var i = 0; i < jsonobj.length; i++) {

                    var styleImageName = uuidv4() + "_flux_txt_to_img.png";
                    console.log("flux_txt_to_img:" + styleImageName);
...
module.exports = FluxPipeTextToImage;