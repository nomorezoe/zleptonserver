    ...
    excuteTask: function (queue) {
        ...
        switch (this.type) {
            case "render":
                ...
                if (this.req.body.rd_style == "flux") {
            ...
            case "ad_texttoloosecolor":
                ...
                break;
            case "ad_texttotightcolor":
                FluxPipeTextToTightColor(this, this.req, queue);
                break;
            case "ad_img_enhance":
    ...
    sendCompleteTaskSuccess: function () {
        ...
        if (socket) {
            ...
            if (this.type == "render") {
                ...
                socket.emit("completeImgEnhance", this.imageFileNames.join(','));
            }
            ...
            else if (this.type == "ad_texttotightcolor") {
                socket.emit("completeTextToTightColor", this.imageFileNames.join(','));
            }
        }
    },
