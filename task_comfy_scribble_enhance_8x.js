...
function TaskComfyScribbleEnhance8X(task, req, queue) {
    console.log("TaskComfyScribbleEnhance8X");

    var session = req.body.session;

    const promptFile = fs.readFileSync('./pipe/workflow_api_scribble_upscale_8x.json');
  ...
  //  prompt["2"]["inputs"]["seed"] = Tool.randomInt();
    ...
    task.pipeline = "scribble_enhance_8x";
    //
        ...
        if (reshttps.statusCode == 200) {
            ...
            reshttps.on('end', (d) => {
                ...
                for (var i = 0; i < jsonobj.length; i++) {
                    ...
                    var imgName =  uuidv4() + "_enhance_8x.png";
                    console.log("enhance_8xImageName:" + imgName);
...
module.exports = TaskComfyScribbleEnhance8X;